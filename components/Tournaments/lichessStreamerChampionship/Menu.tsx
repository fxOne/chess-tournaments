        ...
        <PageMenuContentWrapper sticky={entry && !inView} dark={onDark}>
          <ContentContainer noContainerSpacing fullHeight>
            <Flex justifyContent={'space-between'} alignItems={'center'} fullHeight>
              ...
              <MenuContainer>
                <Link href={routing.de.tournaments.lichessStreamerChampionship.index}>
                  Lichess Streamer Championship
                </Link>
                <Link href={routing.de.tournaments.lichessStreamerChampionship.players}>Spieler</Link>
                <Link href={routing.de.tournaments.lichessStreamerChampionship.pairings}>Paarungen</Link>
              </MenuContainer>
              <MenuContainerMobil>
                {!menuOpen && (
                ...
                {menuOpen && (
                  <Flex direction="column">
                    ...
                    <Link href={routing.de.tournaments.lichessStreamerChampionship.players}>
                      <a onClick={() => setMenuOpen(false)}>Spieler</a>
                    </Link>
                    <Link href={routing.de.tournaments.lichessStreamerChampionship.pairings}>
